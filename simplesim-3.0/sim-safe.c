...
sim_reg_stats(struct stat_sdb_t *sdb)
{
  ...
  //add loads and stores ratio
  stat_reg_formula(sdb, "sim_load_store_ratio",
                   "ratio of loads and stores instructions",
                   "sim_num_refs / sim_num_insn", NULL);
...
#include "machine.def"
      ...
      if (verbose)
	{
      ...
      if (MD_OP_FLAGS(op) & F_STORE  || MD_OP_FLAGS(op) & F_LOAD)
	{
	  sim_num_refs++;
